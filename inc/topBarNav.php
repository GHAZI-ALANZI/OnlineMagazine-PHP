...
<!-- Navbar -->
      ...
      <nav class="bg-info w-100 px-2 py-1 position-fixed top-0" id="login-nav">
        <div class="text-right">
          <a href="./admin" class="mx-2">Admin Panel</a>
          <span class="mx-2">Hallo, <?= $_settings->userdata('username') ?></span>
      ...
      <nav class="main-header navbar navbar-expand navbar-light border border-light border-top-0  border-left-0 border-right-0 navbar-light text-sm bg-info text-light" id='top-Nav'>
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              <li class="nav-item">
                <a href="./" class="nav-link text-light <?= isset($page) && $page =='home' ? "active" : "" ?>">Home</a>
              </li>
              <li class="nav-item dropdown">
                <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle  text-light<?= isset($page) && $page =='categories' ? "active" : "" ?>">Categories</a>
