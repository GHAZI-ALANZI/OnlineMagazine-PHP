                    ...
                    <div class="col-auto flex-grow-1">
                        <div class="col-12">
                            ...
                            <div class="w-100 d-flex justify-content-between align-items-top">
                                <span class="text-info h3">Category: <?= ucwords(isset($category_arr[$row['category_id']]) ? $category_arr[$row['category_id']] : "") ?></span>
                                <div>
                                    <span class="text-info mr-2">Created by: <?= isset($user_arr[$row['user_id']]) ? $user_arr[$row['user_id']] : 'N/A' ?></span>
                                    <span class="text-info"><i class="fa fa-calendar-day text-info"></i> <?= date('Y-m-d H:i',strtotime($row['date_created'])) ?></span>
                                </div>
                            </div>
                            <p>
