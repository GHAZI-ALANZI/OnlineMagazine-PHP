...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-indigo elevation-4 sidebar-no-expand bg-dark text-light">
        <!-- Brand Logo -->
              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-header text-light">Maintenance</li>
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>admin/?page=categories" class="nav-link nav-categories">
                        <i class="nav-icon fas fa-th-list text-light"></i>
                        <p class="text-light">
                          Category List
                        </p>
                      </a>
